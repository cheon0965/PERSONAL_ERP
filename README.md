...
| 월 실행        | 운영 기간 open/close/reopen, 반복 규칙, 계획 항목 생성, 수집 거래 생성/수정/삭제/확정, 텍스트/IM뱅크 PDF 업로드 배치, collect preview/단건 collect/일괄 등록 Job 진행률, 전표 reverse/correct |
| 운영 자산      | 보험 계약, 차량 기본 정보, 차량 연료 이력, 차량 정비 이력, 차량 운영 요약                                                                                                                     |
