...
현재 명시적 레거시 접점은 pre-phase1 데이터 정합성을 위한 backfill 유틸로 좁혀 두었고, demo seed는 더 이상 새 `Transaction` rows를 만들지 않습니다.
...
- [차량 운영 모델 분리 설계](./docs/VEHICLE_OPERATIONS_MODEL_PLAN.md)
...
- [아카이브 문서: 현재 정합성 개선 패치 실행계획](./docs/archive/ALIGNMENT_PATCH_EXECUTION_PLAN.md)
- [아카이브 문서: 메인 비즈니스 흐름 개선 실행계획 및 반영 현황](./docs/archive/BUSINESS_FLOW_IMPROVEMENT_EXECUTION_PLAN.md)
- [아카이브 문서: 금액 정합성 실행계획](./docs/archive/MONEY_INTEGRITY_EXECUTION_PLAN.md)
