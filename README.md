...
- [차량 운영 모델 분리 설계 완료 문서](./docs/completed/VEHICLE_OPERATIONS_MODEL_PLAN.md)
...
- [완료 문서: 저장소 내부 후속 작업 실행계획](./docs/completed/IN_REPO_EXECUTION_PLAN.md)
- [완료 문서: 차량 운영 모델 분리 설계](./docs/completed/VEHICLE_OPERATIONS_MODEL_PLAN.md)
- [완료 문서: 현재 정합성 개선 패치 실행계획](./docs/completed/ALIGNMENT_PATCH_EXECUTION_PLAN.md)
- [완료 문서: 메인 비즈니스 흐름 개선 실행계획 및 반영 현황](./docs/completed/BUSINESS_FLOW_IMPROVEMENT_EXECUTION_PLAN.md)
- [완료 문서: 금액 정합성 실행계획](./docs/completed/MONEY_INTEGRITY_EXECUTION_PLAN.md)
