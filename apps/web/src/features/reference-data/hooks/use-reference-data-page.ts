...
import type { CategoryManagementSubmitInput } from '../components/category-management-form';
import type { FundingAccountManagementSubmitInput } from '../components/funding-account-management-form';
import {
...
} from '../model/reference-data.shared';
import type { FundingAccountBootstrapSubmitInput } from '../components/funding-account-bootstrap-dialog';
        ...
        supplementarySections: [
          currentContextSection,
          {
            ...
            items: [
              ...
              '거래 입력 선택지가 부족하다면 자금수단 또는 카테고리 탭을 먼저 점검합니다.'
            ]
          },
          navigationSection
        ],
