...
import type { JournalEntryAdjustmentDialogProps } from '../model/journal-entry-adjustment-dialog.types';

export type { JournalEntryAdjustmentMode } from '../model/journal-entry-adjustment-dialog.types';
