...
import { collectedTransactionsQueryKey } from '@/features/transactions/api/transactions.api';
...
} from '../model/imports.shared';
import { buildBalanceDiscrepancyBulkCollectConfirmationMessage } from '../model/import-balance-discrepancy-confirmation';
    ...
    supplementarySections: [
      {
        ...
        items: [
          ...
          '우리은행/우리카드 암호화 VestMail 원본은 보안메일 비밀번호 숫자 6자리를 입력하고, KB국민은행 암호화 PDF는 PDF 비밀번호를 입력합니다. 저장 HTML과 비암호화 PDF는 비밀번호를 비워 둡니다.',
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            title: '업로드 운영 현황',
            description:
              '최근 배치의 실패 행, 미수집 행, 등록률을 운영 관점에서 다시 확인합니다.',
