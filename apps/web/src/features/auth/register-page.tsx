...
const termsSections = [
  {
    title: '서비스 목적과 범위',
    body: 'PERSONAL ERP는 소규모 사업자와 개인 운영자가 월 운영, 수집 거래, 업로드 행, 전표, 기준 데이터, 반복 규칙, 차량·보험 등 운영 보조 정보를 정리하도록 돕는 업무 관리 도구입니다. 서비스는 사용자의 장부 정리와 내부 운영 판단을 보조하며, 전문가의 판단이나 외부 제출 업무를 대체하지 않습니다.'
  },
  {
    title: '회원 계정과 보안',
  ...
  },
  {
    ...
    body: '프로젝트의 기능, 화면, 데이터 구조는 개선 과정에서 변경될 수 있습니다. 회원은 중요한 결산이나 외부 제출 전 원천 자료와 전표 결과를 직접 확인해야 하며, 필요한 경우 별도 백업 또는 내보내기를 준비해야 합니다.'
  }
];
