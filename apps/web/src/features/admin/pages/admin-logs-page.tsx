    ...
    supplementarySections: [
      {
        ...
        items: [
          ...
          '작업자 멤버, 대상 종류, 대상 ID로 누가 무엇을 바꿨는지 확인합니다.',
          '실패 또는 거부 결과는 보안 위협 로그와 함께 열어 반복 패턴을 확인합니다.'
        ]
      },
      {
        title: '이어지는 화면',
        links: [
          {
            title: '보안 위협 로그',
            description:
              '접근 거부, 세션 재사용, 반복 인증 실패 같은 보안 이벤트를 함께 추적합니다.',
          ...
          },
          {
            title: '회원 관리',
            description:
              '감사 로그에서 확인한 멤버 역할과 상태를 실제 관리 화면에서 점검합니다.',
            href: '/admin/members',
          ...
          },
          {
            title: '운영 상태',
            description:
              '최근 실패/거부 이벤트가 운영 상태 지표에 어떤 영향을 주는지 확인합니다.',
