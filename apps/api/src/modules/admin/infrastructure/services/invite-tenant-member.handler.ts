...
import { unavailableError } from '../../../../common/application/errors/app-error';
import type {
...
import { buildAdminInvitationUrl } from '../../application/mappers/admin-invitation-url.mapper';
import { mapTenantMemberInvitationToItem } from '../../application/mappers/admin.mapper';

@Injectable()
export class InviteTenantMemberHandler {
  constructor(
