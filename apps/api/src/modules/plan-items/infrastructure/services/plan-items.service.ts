...
import {
  ...
  summarizePlanItems
} from '../mappers/plan-item.mapper';
import type { PlanItemViewPort } from '../../application/ports/plan-item-view.port';
...
@Injectable()
export class PlanItemsService implements PlanItemViewPort {
