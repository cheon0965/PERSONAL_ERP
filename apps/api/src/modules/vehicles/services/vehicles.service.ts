...
import {
  ...
  mapVehicleToItem
} from '../mappers/vehicles.mapper';
import { buildVehicleOperatingSummaryView } from '../projections/vehicle-operating-summary.projection';
...
} from '../model/vehicles.normalization';
