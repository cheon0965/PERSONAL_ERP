...
import { mapOpeningBalanceSnapshotRecordToItem } from '../mappers/opening-balance-snapshot.mapper';
import type { CarryForwardViewPort } from '../../application/ports/carry-forward-view.port';
...
@Injectable()
export class CarryForwardsService implements CarryForwardViewPort {
