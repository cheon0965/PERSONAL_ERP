...
- [`VEHICLE_OPERATING_EXPENSE_ACCOUNTING_EXECUTION_PLAN.md`](./VEHICLE_OPERATING_EXPENSE_ACCOUNTING_EXECUTION_PLAN.md): 차량 연료/정비 이력과 수집거래 연동 1차 구현 완료 후 보관한 실행 계획
