...
이 프로젝트는 Web과 API를 동시에 다루며, 화면과 서버 응답 형태가 쉽게 어긋날 수 있습니다.
...
- 데모 대체 응답은 기본적으로 끄고, 로컬 개발에서만 명시적으로 켠다.
...
- 엔드포인트 형태 변경은 contracts와 문서를 같이 수정한다.
